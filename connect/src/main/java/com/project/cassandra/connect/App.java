...
public class App 
{
    public static void main( String[] args )
    {
     ...
     // Connect to cassandra
        ...
        Cluster cluster = CassandraInitialConnection.getClusterConnection(serverIP);
        
        Session session = CassandraInitialConnection.getKeyspaceConnection(cluster, keyspace);
